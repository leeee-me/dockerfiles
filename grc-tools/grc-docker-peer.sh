...
B=`IFS=$'\n'; (echo "begin"; sleep 0.1s; echo "verbose"; sleep 0.1s; for i in $A; do echo $i; sleep 0.1s; done; echo "end"; sleep 0.1s) | bulkasn | sort -k 7,7 -k 3,3`
...
AC=`echo $A | tr ' ' '\n' | wc -l`
[ -z "$A" ] && AC=0
B=`IFS=$'\n'; (echo "begin"; sleep 0.1s; echo "verbose"; sleep 0.1s; for i in $A; do echo $i; sleep 0.1s; done; echo "end"; sleep 0.1s) | bulkasn`
